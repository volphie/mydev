...
Topic에 Partition을 추가할 때
> kafka-topics.bat --alter --zookeeper localhost:2181 --partitions 2 --topic test-topic

Topic 정보를 조회할 때
> kafka-topics.bat --describe --zookeeper localhost:2181 --topic test-topic